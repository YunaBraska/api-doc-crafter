...
| `enable_object_mapper` | Boolean | Enable Objectmapper additional to the OpenApiParser for more compatibility - can fail due reflection usage - default `false`                        | `100`                                                                    |
